...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ScoreSpaceJam2022", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ScoreSpaceJam2022", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "ScoreSpaceJam2022";
		app.meta["name"] = "ScoreSpaceJam2022";
